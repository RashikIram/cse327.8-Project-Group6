...
function initializeItem1() {
  ...
  <img src=" caffe-americano.jpg" alt="product" />
    <div>
...
function initializeItem2() {
  ...
  <img src=" caffe-misto.jpg" alt="product" />
    <div>
...
function initializeItem4() {
  ...
  <img src=" dark-roast-coffee.jpg" alt="product" />
    <div>
...
function initializeItem8() {
  ...
  <img src=" cappuccino.jpg" alt="product" />
    <div>
...
function initializeItem10() {
  ...
  <img src=" espresso.jpg" alt="product" />
    <div>
...
function initializeItem11() {
  ...
  <img src=" espresso-macchiato.jpg" alt="product" />
    <div>
...
function initializeItem12() {
  ...
  <img src=" flat-white.jpg" alt="product" />
    <div>
